...
import WI4 from './work_items/WI4.jsx';
import WI5 from './work_items/WI5.jsx'
...
let ua = parser();
const WORKITEMS = [WI5, WI4, WI1, WI2, WI3];
...
class Experience extends React.Component {
  ...
  toggleScrollButton(side) {
    return (this.state.itemInView === 4 && side === "R") ? " hidden" : (this.state.itemInView === 0 && side === "L") ? " hidden" : "";
  }
